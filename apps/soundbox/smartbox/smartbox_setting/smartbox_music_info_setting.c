...
{
    JL_rcsp_event_to_user(DEVICE_EVENT_FROM_RCSP, MSG_JL_AVRCP_CH_SYNC_MUSIC_INFO, NULL, 0);
}

void music_sync_info(void)
{
...
void bt_status_change(u8 state)
{
    ...
    if ((tws_api_get_tws_state() & TWS_STA_SIBLING_CONNECTED) == 0) {
        ...
        JL_rcsp_event_to_user(DEVICE_EVENT_FROM_RCSP, MSG_JL_PLAYER_STATE_CHANGE, NULL, 0);
    }
}

void music_player_status_change(void)
{
